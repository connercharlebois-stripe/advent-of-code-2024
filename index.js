...
var _a = require("./day2/reportGrader"), gradeOne = _a.gradeOne, gradeAllPossibilities = _a.gradeAllPossibilities;
var fileStream = fs.createReadStream('./day2/input.txt');
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var passes, fails, total, _a, rl_1, rl_1_1, line, res, res2, e_1_1;
        var _b, e_1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    total++;
                    res = gradeOne(line);
                    res2 = gradeAllPossibilities(line);
                    console.log({ line: line, res: res, res2: res2 });
                    if (res2) {
                        passes++;
                    }
                    else {
                ...
                case 12:
                    console.log({ passes: passes, fails: fails, total: total });
                    return [2 /*return*/];
            }
        });
    });
